# Migration `20191204225047-initial-schema`

This migration has been generated by lvnr at 12/4/2019, 10:50:47 PM.
...
CREATE TABLE "public"."Headphone_images" (
  "nodeId" text NOT NULL  REFERENCES "public"."Headphone"("id") ON DELETE CASCADE,
...
CREATE TABLE "public"."HeadphoneReview_takeaways" (
  "nodeId" text NOT NULL  REFERENCES "public"."HeadphoneReview"("id") ON DELETE CASCADE,
  "position" integer NOT NULL  ,
  "value" text NOT NULL  ,
  PRIMARY KEY ("nodeId","position")
);
...
You can use a specific Photon built for this migration (20191204225047-initial-schema)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191204225047-initial-schema'
